...
For the ABU Robocon 2026, we need a program that will identify the input of the camera and classify it into three: Robocon logo, Oracle bone symbols and Random or Fake symbols. To do this, I have utilised CNN.
...
Download the program in the same folder
Download tensorflow, opencv, numpy, skimage, keras
Run the code

It's that simple.

I am also attaching the inference script that should work with an onnx model which i will use once i have figured out the issues. The keras model and the onnx model are also uploaded. Data base contains 120 images (55 each of fake and real and 40 of logo)
